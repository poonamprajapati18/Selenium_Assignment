...
public static void main(String[] args) throws InterruptedException {
	...
	email.sendKeys("poonamalaviya8989@gmail.com");
	 ...
	 month.selectByIndex(8);
	  String mydate ="8";
	 List<WebElement> dates = driver.findElements(By.xpath("//div[@class='react-datepicker__day react-datepicker__day--008 react-datepicker__day--selected']"));
	...
	P1_Screenshot.getScreenShot(driver,"\"D:\\ScreenshotFb\\data\"");
